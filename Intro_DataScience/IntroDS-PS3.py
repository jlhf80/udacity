...
def entries_histogram(turnstile_weather):
    ...
    y = turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==1] # your code here to plot a historgram for hourly entries when it is raining
    x = turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain'] ==0] # your code here to plot a historgram for hourly entries when it is not raining
    plt.figure()
    x.hist(bins=25)
    y.hist(bins=25)
    return plt
...
def mann_whitney_plus_means(turnstile_weather):
    ...
    entries_no_rain = turnstile_weather['ENTRIESn_hourly'][turnstile_weather['rain']==0]
    with_rain_mean = np.mean(entries_rain)
    without_rain_mean = np.mean(entries_no_rain)
    U, p = scipy.stats.mannwhitneyu(entries_rain, entries_no_rain, use_continuity=True)
