# Data Science Problem set 2, number 1
import pandas
import pandasql
...
def num_rainy_days(filename):
    ...
    q = """ select count(*) from weather_data where cast(rain as integer);
...
def avg_min_temperature(filename):
    ...
    q = """select avg(cast (mintempi as integer)) from weather_data['mintempi'] where cast(mintempi as integer) > 55 and rain=1;
    """
...
def filter_by_regular(filename):
    ...
    filter = (turnstile_data.DESCn == 'REGULAR')
    turnstile_data = turnstile_data[filter]
