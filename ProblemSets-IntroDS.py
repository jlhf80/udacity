...
def custom_heuristic(file_path):
    ...
    """for passenger_index, passenger in df.iterrows():
        passenger_id = passenger['PassengerId']
        median = numpy.mean(passenger['Fare'])
        agemedian = numpy.mean(passenger['Age'])
        if passenger['Sex'] == 'male':
            predictions[passenger_id] = 0
        elif passenger['Pclass'] == '1' or (passenger['Pclass'] == '2'):
            predictions[passenger_id] = 1
        elif passenger['Fare'] > median and (passenger['Age'] > agemedian):
            predictions[passenger_id] = 1
        else:
            predictions[passenger_id] = 0"""
        ...
        #else:
            #predictions[passenger_id] = 0 
        #if passenger['Age'] < 18 and (passenger['Parch'] < 5):
            #predictions[passenger_id] = 1
        #else:
            #predictions[passenger_id] = 0
